...
>>>>>>> 238afb4b0e02f1029708088edf6de4944fed6e32
...
class TransformerModel(AttModel):
    ...
    def __init__(self, opt):
        ...
        self.att_embed = nn.Sequential(*(((nn.BatchNorm1d(self.att_feat_size),) if self.use_bn else ()) + (
            nn.Linear(self.att_feat_size, self.d_model), nn.ReLU(), nn.Dropout(self.drop_prob_lm)) + (
        ...
        self.model = self.make_model(0, tgt_vocab, N_enc=self.N_enc, N_dec=self.N_dec, d_model=self.d_model,
