...
def parse_opt():
    ...
    parser.add_argument('--caption_model', type=str, default="show_tell",
                        help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, '
                             'adaattmo, updown, stackatt, denseatt, transformer')
    ...
    parser.add_argument('--N_enc', type=int, default=6,
                        help='# of encoder layers')
    parser.add_argument('--N_dec', type=int, default=6,
                        help='# of decoder layers')
    parser.add_argument('--d_model', type=int, default=512,
                        help='model dimension of transformer')
    parser.add_argument('--d_ff', type=int, default=2048,
                        help='feedforward layer dimension of transformer')
...
def add_eval_options(parser):
    ...
    parser.add_argument('--input_json', type=str, default='', 
                        help='path to the json file containing additional info and vocab. empty = fetch from model '
                             'checkpoint.')
    parser.add_argument('--split', type=str, default='test', 
                        help='if running on MSCOCO images, which split to use: val|test|train')
    parser.add_argument('--coco_json', type=str, default='', 
                        help='if nonempty then use this file in DataLoaderRaw (see docs there). Used only in '
                             'MSCOCO test evaluation, where we have a specific json file of only test set images.')
    # misc
    parser.add_argument('--id', type=str, default='', 
...
def add_eval_sample_opts(parser):
    ...
    parser.add_argument('--diversity_lambda', type=float, default=0.5,
                        help='used for diverse beam search. Usually from 0.2 to 0.8. Higher value of lambda '
                             'produces a more diverse list')
